...
void main() {
  ...
  group('golden GG', () {
    test(
      'GG-001 Small Easy accepts solvable board',
      () {
    ...
    test(
      'GG-002 Stock Heavy template can accept',
      () {
    ...
    test(
      'GG-003 Restore Required path is solvable (Restore available)',
      () {
    ...
    test(
      'GG-004 Reveal Heavy template can accept',
      () {
    ...
    test(
      'GG-005 Tight Move Limit still accepts when solvable',
      () {
        // First find a comfortable solution length, then regenerate with tight limit.
        final probe = GeneratorFixtures.generateEarly3x1(
          seed: 55,
          moveLimit: 40,
        );
    ...
    test(
      'GG-010 Deterministic seed reproduces board',
      () {
    ...
    test(
      'GG-011 Retry determinism with difficulty gate',
      () {
