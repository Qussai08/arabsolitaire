...
class BundleManifest {
  ...
  Map<String, dynamic> toJson() => {
    ...
    'status': status,
    if (bundleBuilderVersion != null)
      'bundleBuilderVersion': bundleBuilderVersion,
    if (contentValidatorVersion != null)
      'contentValidatorVersion': contentValidatorVersion,
...
class LevelDto {
  ...
  factory LevelDto.fromJson(Map<String, dynamic> j) => LevelDto(
    ...
    boardDifficultyTarget: (j['boardDifficultyTarget'] as num).toDouble(),
    semanticDifficultyTier: (j['semanticDifficultyTier'] as num).toInt(),
...
class AssociationVariantDto {
  ...
  factory AssociationVariantDto.fromJson(Map<String, dynamic> j) =>
      AssociationVariantDto(
        ...
        memberCards: (j['memberCards'] as List<dynamic>).cast<String>(),
        contentType: j['contentType'] as String,
        semanticDifficulty: (j['semanticDifficulty'] as num).toInt(),
        visualFlag: (j['visualFlag'] as bool?) ?? false,
        chapterEligibility: (j['chapterEligibility'] as List<dynamic>)
            .cast<String>(),
        status: j['status'] as String,
...
class DisableMetadata {
  ...
  bool isLevelDisabled(String levelId) => disabledLevelIds.contains(levelId);
  ...
  factory DisableMetadata.fromJson(Map<String, dynamic> j) => DisableMetadata(
    disabledBundleVersions:
        ((j['disabledBundleVersions'] as List<dynamic>?) ?? []).cast<String>(),
    disabledLevelIds: ((j['disabledLevelIds'] as List<dynamic>?) ?? [])
        .cast<String>(),
    disabledAssociationVariantIds:
        ((j['disabledAssociationVariantIds'] as List<dynamic>?) ?? [])
            .cast<String>(),
    disabledStoryBeatIds: ((j['disabledStoryBeatIds'] as List<dynamic>?) ?? [])
        .cast<String>(),
...
class LocalContentMetadata {
  ...
  factory LocalContentMetadata.fromJson(Map<String, dynamic> j) =>
      LocalContentMetadata(
        ...
        lastUpdateCheckAt: j['lastUpdateCheckAt'] != null
            ...
            : null,
        lastSuccessfulActivationAt: j['lastSuccessfulActivationAt'] != null
            ? DateTime.tryParse(j['lastSuccessfulActivationAt'] as String)
            : null,
        activeContentHash: j['activeContentHash'] as String?,
        quarantinedVersions:
            ((j['quarantinedVersions'] as List<dynamic>?) ?? []).cast<String>(),
      );

  Map<String, dynamic> toJson() => {
    if (activeBundleVersion != null) 'activeBundleVersion': activeBundleVersion,
    ...
    if (lastSuccessfulActivationAt != null)
      'lastSuccessfulActivationAt': lastSuccessfulActivationAt!
          .toIso8601String(),
    if (activeContentHash != null) 'activeContentHash': activeContentHash,
  ...
  LocalContentMetadata copyWith({
    ...
    previousBundleVersion: previousBundleVersion ?? this.previousBundleVersion,
    ...
    quarantinedVersions: quarantinedVersions ?? this.quarantinedVersions,
  );
}
