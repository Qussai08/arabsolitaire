...
class ContentAnalytics {
    ...
    required String contentHash,
      ...
      _fa.logEvent(
        ...
        parameters: {
          ...
          'content_hash': contentHash.substring(
              0, contentHash.length.clamp(0, 36)),
        },
      );

  Future<void> logDownloadStarted(String bundleVersion) =>
      _fa.logEvent(
  ...
  Future<void> logDownloadCompleted(
          String bundleVersion, int durationMs) =>
      _fa.logEvent(
  ...
  Future<void> logValidationFailed(
      String bundleVersion, String errorCode) =>
      _fa.logEvent(
  ...
  Future<void> logRollback(String toVersion) =>
      _fa.logEvent(
